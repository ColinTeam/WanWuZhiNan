 ...
 */
open class SimpleTextFormatter<T> @JvmOverloads constructor(private val format: String = "%s") : TextFormatter {
 ...
 */
class IntTextFormatter @JvmOverloads constructor(format: String = DEFAULT_INT_FORMAT) : SimpleTextFormatter<Int>(format) {
