...
import com.ad.img_load.pickerview.pv.configure.PickerOptions;
import com.ad.img_load.pickerview.pv.listener.OnDismissListener;
import com.ad.img_load.pickerview.pv.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.base_picker_view, mPickerOptions.decorView, false);
