...
class VideoListPadActivity : BaseActivity<ActivityVideoListPadBinding, UserViewModel>(UserViewModel()){
...
//            }
            ...
            Log.e("TAG", "mChildPosition :${(65)*level.toInt()} ${adapterHeight} ${mChildPosition} --- ${top}" )
