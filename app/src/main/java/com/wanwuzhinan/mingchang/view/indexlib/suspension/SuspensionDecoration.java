package com.wanwuzhinan.mingchang.view.indexlib.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#FFF7F8F9");
    private static int COLOR_TITLE_BOTTOM_LINE = Color.parseColor("#00FFFFFF");
    private static int COLOR_TITLE_FONT = Color.parseColor("#FF0F050B");
