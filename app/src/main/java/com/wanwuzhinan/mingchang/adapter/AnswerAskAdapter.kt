...
class AnswerAskAdapter : BaseQuickAdapter<QuestionListData.QuestionBean?, QuickViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: QuickViewHolder, position: Int, item: QuestionListData.QuestionBean?
    ) {
        ...
        GlideImgManager.get().loadImgFitCenter(
            item.title_img, holder.getView(R.id.iv_topic), R.drawable.img_default_icon
        )
        ...
        mAdapter.setOnDebouncedItemClick() { _, _, cposition ->
            if (mListener != null) {
