...
class VideoHomeAdapter : BaseQuickAdapter<LessonQuarter,QuickViewHolder>() {
    override fun onBindViewHolder(holder: QuickViewHolder, position: Int, item: LessonQuarter?) {
