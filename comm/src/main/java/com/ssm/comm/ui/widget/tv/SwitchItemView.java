...
public class SwitchItemView extends ConstraintLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        root = LayoutInflater.from(context).inflate(R.layout.base_layout_item_switch, this);
        tvTitle = findViewById(com.ssm.comm.R.id.tv_title);
        ...
        titleColor = a.getColor(R.styleable.SwitchItemView_switchItemTitleColor, ContextCompat.getColor(getContext(), R.color.black));
        if (titleColorId != -1) {
